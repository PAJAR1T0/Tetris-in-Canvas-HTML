export { loadAudios, cantRotateAudio, clearLineAudio, gameOverAudio, mainAudio, newPieceAudio, newRecordAudio, nextLevelAudio } from './soundLogic';
export { main, ctx, gameLoop } from './main';
...
export { moveLogic, resetRadians, resetInterval, interval, radians, level } from './moveLogic';
export { lineChecker } from './lineCompleteChecker';
export { frameLogic, frame } from './frameLogic';
export { rotateLogic } from './rotateLogic';
